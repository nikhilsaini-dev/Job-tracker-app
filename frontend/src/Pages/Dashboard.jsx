...
// // //       {/* Sidebar */}
// // //       <motion.div
// // //         className="hidden md:block w-64 bg-slate-800 p-6 flex-col"
// // //         initial={{ x: -100, opacity: 0 }}
// // //         animate={{ x: 0, opacity: 1 }}
// // //       >
// // //         <h1 className="text-3xl font-bold mb-10 cursor-pointer hover:text-indigo-400 transition">
// // //           JobTrack
// // //         </h1>
...
// //       {/* Sidebar */}
// //       <motion.div
// //         className="hidden md:flex flex-col w-64 bg-slate-800 p-6"
...
//           <motion.div
//             className="fixed md:relative inset-y-0 left-0 w-64 bg-slate-800 p-6 flex flex-col z-40"
//             initial={{ x: -300 }}
//             animate={{ x: 0 }}
//             exit={{ x: -300 }}
...
//         {/* ... rest of your main content stays same ... */}
//         {/* Top section, stats, jobs, modal etc. */}
//       </div>
//     </div>
//   );
// }
